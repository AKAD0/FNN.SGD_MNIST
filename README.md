...
\left[ 
\begin{matrix} 
a^{(y)}_1 (1-a^{(y)}_1), & a^{(y)}_2 a^{(y)}_1,     & ~...~,  & a^{(y)}_{10} a^{(y)}_1 \\
a^{(y)}_1 a^{(y)}_2,     & a^{(y)}_2 (1-a^{(y)}_2), & ~...~,  & a^{(y)}_{10} a^{(y)}_2 \\
~...~,                  & ~...~,                  & ~...~,  & ~...~ \\
a^{(y)}_1 a^{(y)}_{10},  & a^{(y)}_2 a^{(y)}_{10},  & ~...~,  & a^{(y)}_{10} (1-a^{(y)}_{10})
\end{matrix}
\right] \\
&=
\left[
\begin{matrix} 
\sum\limits_{k=1}^{10} (a^{(y)}_k a^{(y)}_1)-a^{(y)}_1 a^{(y)}_1+a^{(y)}_1 (1-a^{(y)}_1) \\
~...~ \\
\sum\limits_{k=1}^{10} (a^{(y)}_k a^{(y)}_{10})-a^{(y)}_{10} a^{(y)}_{10}+a^{(y)}_{10} (1-a^{(y)}_{10})
\end{matrix}
\right] 
\end{aligned}
$$
