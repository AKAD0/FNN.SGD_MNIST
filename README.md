...
$$
\begin{aligned}
&\nabla _{w{(y)}} C = \frac{C}{w^{(y)}} = S_1a^{(2)} \\
&\nabla _{b{(y)}} C = \frac{C}{b^{(y)}} = S_1 \\
&\nabla _{w{(2)}} C = \frac{C}{w^{(2)}} = S_1 S_2 a^{(1)} \\
&\nabla _{b{(2)}} C = \frac{C}{b^{(2)}} = S_1 S_2 \\
&\nabla _{w{(1)}} C = \frac{C}{w^{(1)}} = S_1 S_2 S_3 x \\
&\nabla _{b{(1)}} C = \frac{C}{b^{(1)}} = S_1 S_2 S_3 \\
\end{aligned}
$$
